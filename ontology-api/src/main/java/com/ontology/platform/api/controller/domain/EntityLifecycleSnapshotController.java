...
public class EntityLifecycleSnapshotController {
    ...
    public ResponseEntity<ApiResponse<EntityLifecycleSnapshotResponse>> create(@PathVariable String ontologyId,
    ...
    public ResponseEntity<ApiResponse<EntityLifecycleSnapshotResponse>> getById(@PathVariable String id) {
