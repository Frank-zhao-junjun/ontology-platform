...
@Slf4j
@RestController
@RequestMapping("/v1/ontologies/{ontologyId}/notifications")
...
public class NotificationDefinitionController {
    ...
    public ResponseEntity<ApiResponse<List<NotificationDefinitionResponse>>> list(@PathVariable String ontologyId) {
    ...
    public ResponseEntity<ApiResponse<NotificationDefinitionResponse>> getById(@PathVariable String id) {
