...
public class PolicyRuleController {
    ...
    public ResponseEntity<ApiResponse<List<PolicyRuleResponse>>> list(@PathVariable String ontologyId) {
    ...
    public ResponseEntity<ApiResponse<PolicyRuleResponse>> getById(@PathVariable String id) {
