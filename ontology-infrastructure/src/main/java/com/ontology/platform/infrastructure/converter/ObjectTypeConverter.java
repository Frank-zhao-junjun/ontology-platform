...
public class ObjectTypeConverter {
    ...
    public ObjectType toEntity(ObjectTypePO po) {
        ...
        return ObjectType.builder()
                ...
                .entityRole(po.getEntityRole() != null ? po.getEntityRole() : "aggregate_root")
                .parentAggregateId(po.getParentAggregateId())
                .businessScenarioId(po.getBusinessScenarioId())
                .subDomain(po.getSubDomain())
                .attributesJsonb(po.getAttributesJsonb() != null ? po.getAttributesJsonb() : "{}")
    ...
    public ObjectTypePO toPO(ObjectType entity) {
        ...
        ObjectTypePO po = ObjectTypePO.builder()
                ...
                .entityRole(entity.getEntityRole() != null ? entity.getEntityRole() : "aggregate_root")
                ...
                .attributesJsonb(entity.getAttributesJsonb() != null ? entity.getAttributesJsonb() : "{}")
