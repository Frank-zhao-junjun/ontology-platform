...
import com.ontology.platform.domain.port.AgentBridgePort;
import com.ontology.platform.domain.port.AgentBridgePort.AgentResult;
...
class AgentOrchestrationServiceTest {
    ...
    @Mock
    private AgentBridgePort bridgeService;
